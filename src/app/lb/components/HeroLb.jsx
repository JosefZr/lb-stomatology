      ...
      >
        <div className='flex items-center justify-center flex-row gap-7 max-lg:flex-col xl:max-w-6xl max-[500px]:mx-1 mx-10 mt-20'>
          ...
          <div className='flex flex-col items-start max-lg:items-center justify-center max-md:items-center gap-6 mb-4 '>
            <h1 className=' text-center text-2xl min-[300px]:text-3xl sm:text-5xl lg:text-5xl font-extrabold lg:text-left capitalize text-bold-purple'>Why You Should Choose Dental Implants over other Solutions !?</h1>
            <h2 className=' text-center min-[300px]:text-3xl sm:text-4xl lg:text-4xl font-bold md:text-left capitalize '>
