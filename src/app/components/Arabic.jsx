...
export default function Arabic() {
    ...
    return (
        <div className='flex flex-row items-center justify-center gap-1 px-10 max-[550px]:px-2 text-center mb-20'>
        <div className=' flex flex-col gap-10 text-4xl max-[450px]:text-xl font-bold   '>
